...
const LOCALES = {
  th: {
    ...
    fieldRegisterName: 'ชื่อของคุณ', fieldRegisterEmail: 'อีเมล',
    fieldAdminUsername: 'ชื่อผู้ใช้ admin', fieldAdminPassword: 'รหัสผ่าน admin', fieldTotpCode: 'รหัส 2FA 6 หลัก',
    menuBugReport: 'แจ้งปัญหา / ข้อเสนอแนะ', bugReportTitle: 'แจ้งปัญหา / ข้อเสนอแนะ',
    fieldBugReportMessage: 'อธิบายปัญหาหรือข้อเสนอแนะ', btnSendReport: 'ส่งรายงาน',
    bugReportSent: 'ส่งรายงานแล้ว ขอบคุณครับ!', bugReportFailed: 'ส่งไม่สำเร็จ',
  ...
  en: {
    ...
    fieldRegisterName: 'Your name', fieldRegisterEmail: 'Email',
    fieldAdminUsername: 'Admin username', fieldAdminPassword: 'Admin password', fieldTotpCode: '6-digit 2FA code',
    menuBugReport: 'Report a bug / suggestion', bugReportTitle: 'Report a bug / suggestion',
    fieldBugReportMessage: 'Describe the problem or suggestion', btnSendReport: 'Send report',
    bugReportSent: 'Report sent, thank you!', bugReportFailed: 'Failed to send',
  ...
  ja: {
    ...
    fieldRegisterName: 'お名前', fieldRegisterEmail: 'メールアドレス',
    fieldAdminUsername: '管理者ユーザー名', fieldAdminPassword: '管理者パスワード', fieldTotpCode: '2FAコード（6桁）',
    menuBugReport: 'バグ報告 / 提案', bugReportTitle: 'バグ報告 / 提案',
    fieldBugReportMessage: '問題または提案を説明してください', btnSendReport: '送信',
    bugReportSent: '送信しました。ありがとうございます！', bugReportFailed: '送信に失敗しました',
