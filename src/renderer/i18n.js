...
const LOCALES = {
  th: {
    ...
    menuGiftCode: 'สร้างโค้ดของขวัญ (Admin)',
    giftCodeTitle: 'สร้างโค้ดของขวัญ (Admin)',
    giftCodeSub: 'สร้างโค้ดใช้งานฟรีให้ใครสักคนแบบไม่ผ่านการจ่ายเงิน — ใช้ private key ในเครื่องนี้',
    giftLifetime: 'ใช้งานได้ตลอดชีพ', giftDays: 'จำนวนวันที่ใช้ได้', giftNote: 'หมายเหตุ (เช่น ชื่อคนที่ให้)',
    giftResultLabel: 'โค้ดที่สร้าง', btnGenerateGiftCode: 'สร้างโค้ด', btnCopyCode: 'คัดลอกโค้ด',
    ...
    fieldQuality: 'คุณภาพวิดีโอ', qualityBest: 'ดีที่สุด', btnDownloadLater: 'ดาวน์โหลดภายหลัง',
    fieldCategory: 'หมวดหมู่', checkRememberFolder: 'จดจำโฟลเดอร์นี้ไว้สำหรับหมวดหมู่ที่เลือก',
    fieldDescription: 'คำอธิบาย (ถ้ามี)',
    ...
    checkLaunchOnStartup: 'เปิดโปรแกรมอัตโนมัติเมื่อเปิดเครื่อง Windows',
    ...
    checkDarkMode: 'โหมดมืด (Dark mode)',
    ...
    btnUpdateDownloading: 'กำลังดาวน์โหลด...', btnRestartToInstall: 'รีสตาร์ตเพื่อติดตั้ง',
    fieldLicenseCode: 'กรอกโค้ดใช้งาน (ถ้ามี)', btnActivateLicense: 'เปิดใช้งานโค้ด',
    btnBuyLicense: 'ยังไม่มีโค้ด? ซื้อ/ต่ออายุออนไลน์',
  ...
  en: {
    ...
    menuGiftCode: 'Generate gift code (Admin)',
    giftCodeTitle: 'Generate gift code (Admin)',
    giftCodeSub: 'Issue a free-to-use code for someone, no payment involved — uses the private key on this machine.',
    giftLifetime: 'Lifetime access', giftDays: 'Number of days valid', giftNote: 'Note (e.g. who it\'s for)',
    giftResultLabel: 'Generated code', btnGenerateGiftCode: 'Generate code', btnCopyCode: 'Copy code',
    ...
    fieldQuality: 'Video quality', qualityBest: 'Best', btnDownloadLater: 'Download later',
    fieldCategory: 'Category', checkRememberFolder: 'Remember this folder for the selected category',
    ...
    checkLaunchOnStartup: 'Launch automatically when Windows starts',
    ...
    btnUpdateDownloading: 'Downloading...', btnRestartToInstall: 'Restart to install',
    fieldLicenseCode: 'Enter license code (if you have one)', btnActivateLicense: 'Activate code',
    btnBuyLicense: 'No code yet? Buy / renew online',
  ...
  ja: {
    ...
    menuGiftCode: 'ギフトコード発行（管理者用）',
    giftCodeTitle: 'ギフトコード発行（管理者用）',
    giftCodeSub: '支払いなしで無料コードを発行します — このマシンの秘密鍵を使用',
    giftLifetime: '永久利用', giftDays: '有効日数', giftNote: 'メモ（例：発行相手の名前）',
    giftResultLabel: '発行されたコード', btnGenerateGiftCode: 'コードを発行', btnCopyCode: 'コードをコピー',
    ...
    fieldQuality: '動画の画質', qualityBest: '最高画質', btnDownloadLater: '後でダウンロード',
    fieldCategory: 'カテゴリー', checkRememberFolder: '選択したカテゴリー用にこのフォルダを記憶する',
    ...
    checkLaunchOnStartup: 'Windows起動時に自動的に起動する',
    ...
    btnUpdateDownloading: 'ダウンロード中...', btnRestartToInstall: '再起動してインストール',
    fieldLicenseCode: 'ライセンスコードを入力（お持ちの場合）', btnActivateLicense: 'コードを有効化',
    btnBuyLicense: 'コードをお持ちでない方はこちらから購入・更新',
